package local.kongyu.mybatisFlexPostGis.generator;
...
public class MybatisFlexGenerator {
    ...
    public static void main(String[] args) {
        ...
        dataSource.setUrl("jdbc:postgresql://192.168.1.10:32297/kongyu_bms?currentSchema=public");
    ...
    public static GlobalConfig createGlobalConfigUseStyle() {
        ...
        globalConfig.getPackageConfig()
                ...
                .setBasePackage("local.kongyu.generator");
        ...
        globalConfig.getStrategyConfig()
                //.setGenerateTable("sys_user", "sys_dept") // 生成哪些表，白名单
                .setUnGenerateTable("test", "demo"); // 不生成哪些表，黑名单
