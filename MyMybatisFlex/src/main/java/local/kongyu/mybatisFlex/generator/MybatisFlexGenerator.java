package local.kongyu.mybatisFlex.generator;
...
public class MybatisFlexGenerator {
    // 生成的包路径
    private static final String BasePackage = "local.kongyu.mybatisFlex";
    // 需要生成的表
    ...
    public static void main(String[] args) {
        ...
        dataSource.setUrl("jdbc:mysql://192.168.1.10:35896/kongyu");
